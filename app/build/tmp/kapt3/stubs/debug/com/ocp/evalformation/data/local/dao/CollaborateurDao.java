...
public abstract interface CollaborateurDao {
    ...
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object upsertCollaborateurs(@org.jetbrains.annotations.NotNull()
    java.util.List<com.ocp.evalformation.data.local.entity.CollaborateurEntity> collabs, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super java.util.List<java.lang.String>> $completion);
    ...
    public static final class DefaultImpls {
        ...
        @androidx.room.Transaction()
        @org.jetbrains.annotations.Nullable()
        public static java.lang.Object upsertCollaborateurs(@org.jetbrains.annotations.NotNull()
        com.ocp.evalformation.data.local.dao.CollaborateurDao $this, @org.jetbrains.annotations.NotNull()
        java.util.List<com.ocp.evalformation.data.local.entity.CollaborateurEntity> collabs, @org.jetbrains.annotations.NotNull()
        kotlin.coroutines.Continuation<? super java.util.List<java.lang.String>> $completion) {
            return null;
        }
