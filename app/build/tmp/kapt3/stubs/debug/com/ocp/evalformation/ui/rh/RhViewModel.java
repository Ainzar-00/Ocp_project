...
public final class RhViewModel extends androidx.lifecycle.AndroidViewModel {
    ...
    @org.jetbrains.annotations.NotNull()
    private final androidx.lifecycle.LiveData<java.util.List<com.ocp.evalformation.data.local.entity.InvitationFlmEntity>> pendingInvitations = null;
    @org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<java.util.List<com.ocp.evalformation.data.local.entity.InvitationFlmEntity>> getPendingInvitations() {
        return null;
    }
