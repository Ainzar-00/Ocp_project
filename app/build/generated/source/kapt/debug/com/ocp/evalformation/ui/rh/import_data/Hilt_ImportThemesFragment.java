...
public abstract class Hilt_ImportThemesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImportThemesFragment() {
    super();
  }

  Hilt_ImportThemesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImportThemesFragment_GeneratedInjector) this.generatedComponent()).injectImportThemesFragment(UnsafeCasts.<ImportThemesFragment>unsafeCast(this));
    }
  }
