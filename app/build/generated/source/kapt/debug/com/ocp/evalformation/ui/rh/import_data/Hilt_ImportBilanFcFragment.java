...
public abstract class Hilt_ImportBilanFcFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImportBilanFcFragment() {
    super();
  }

  Hilt_ImportBilanFcFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImportBilanFcFragment_GeneratedInjector) this.generatedComponent()).injectImportBilanFcFragment(UnsafeCasts.<ImportBilanFcFragment>unsafeCast(this));
    }
  }
