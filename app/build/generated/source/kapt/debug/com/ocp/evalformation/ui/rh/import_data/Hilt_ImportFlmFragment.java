...
public abstract class Hilt_ImportFlmFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImportFlmFragment() {
    super();
  }

  Hilt_ImportFlmFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImportFlmFragment_GeneratedInjector) this.generatedComponent()).injectImportFlmFragment(UnsafeCasts.<ImportFlmFragment>unsafeCast(this));
    }
  }
