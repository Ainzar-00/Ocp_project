...
public abstract class Hilt_ImportDataFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImportDataFragment() {
    super();
  }

  Hilt_ImportDataFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImportDataFragment_GeneratedInjector) this.generatedComponent()).injectImportDataFragment(UnsafeCasts.<ImportDataFragment>unsafeCast(this));
    }
  }
