...
import com.ocp.evalformation.data.local.dao.FormDao_Impl;
...
public final class OcpDatabase_Impl extends OcpDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(11) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `forms` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `themeId` INTEGER NOT NULL, `formUrl` TEXT NOT NULL, `formationId` INTEGER NOT NULL, `intituleAction` INTEGER NOT NULL, `nomPrenom` INTEGER NOT NULL, `service` INTEGER NOT NULL, `dates` INTEGER NOT NULL, `formateur` INTEGER NOT NULL, `matricule` INTEGER NOT NULL)");
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsFormations = new HashMap<String, TableInfo.Column>(17);
        ...
        _columnsFormations.put("Formateur", new TableInfo.Column("Formateur", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFormations.put("dateAppreciation", new TableInfo.Column("dateAppreciation", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsFormations.put("entite", new TableInfo.Column("entite", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFormations.put("categorie", new TableInfo.Column("categorie", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFormations.put("division", new TableInfo.Column("division", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFormations.put("convocation", new TableInfo.Column("convocation", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFormations.put("presence", new TableInfo.Column("presence", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFormations.put("session", new TableInfo.Column("session", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFormations.put("jsp", new TableInfo.Column("jsp", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFormations.put("type", new TableInfo.Column("type", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFormations.put("domaine", new TableInfo.Column("domaine", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsInvitationsFlm.put("service", new TableInfo.Column("service", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsInvitationsFlm.put("themeNom", new TableInfo.Column("themeNom", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsInvitationsFlm.put("themeObjectives", new TableInfo.Column("themeObjectives", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashMap<String, TableInfo.Column> _columnsForms = new HashMap<String, TableInfo.Column>(10);
        ...
        final TableInfo _existingForms = TableInfo.read(db, "forms");
        if (!_infoForms.equals(_existingForms)) {
          return new RoomOpenHelper.ValidationResult(false, "forms(com.ocp.evalformation.data.local.entity.Forms).\n"
                  + " Expected:\n" + _infoForms + "\n"
                  + " Found:\n" + _existingForms);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "ac09a9d5387dac86db157b845517ed28", "745b55a43bb7647155f0f0a881c9b4a5");
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(FormDao.class, FormDao_Impl.getRequiredConverters());
  ...
  public FormDao formDao() {
    if (_formDao != null) {
      ...
      synchronized(this) {
        if(_formDao == null) {
          _formDao = new FormDao_Impl(this);
        }
        return _formDao;
      }
    }
