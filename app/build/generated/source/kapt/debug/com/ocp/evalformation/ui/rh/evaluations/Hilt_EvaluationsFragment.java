...
public abstract class Hilt_EvaluationsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EvaluationsFragment() {
    super();
  }

  Hilt_EvaluationsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EvaluationsFragment_GeneratedInjector) this.generatedComponent()).injectEvaluationsFragment(UnsafeCasts.<EvaluationsFragment>unsafeCast(this));
    }
  }
