...
public abstract class Hilt_ImportBilanFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImportBilanFragment() {
    super();
  }

  Hilt_ImportBilanFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImportBilanFragment_GeneratedInjector) this.generatedComponent()).injectImportBilanFragment(UnsafeCasts.<ImportBilanFragment>unsafeCast(this));
    }
  }
