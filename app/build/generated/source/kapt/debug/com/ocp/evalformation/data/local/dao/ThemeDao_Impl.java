  ...
  public Object insert(final ThemeEntity theme, final Continuation<? super Long> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Long>() {
      ...
      public Long call() throws Exception {
        ...
        try {
          final Long _result = __insertionAdapterOfThemeEntity.insertAndReturnId(theme);
  ...
  public Object insertAll(final List<ThemeEntity> themes,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<List<Long>>() {
      ...
      public List<Long> call() throws Exception {
        __db.beginTransaction();
        try {
          final List<Long> _result = __insertionAdapterOfThemeEntity_1.insertAndReturnIdsList(themes);
          __db.setTransactionSuccessful();
          return _result;
        } finally {
          __db.endTransaction();
