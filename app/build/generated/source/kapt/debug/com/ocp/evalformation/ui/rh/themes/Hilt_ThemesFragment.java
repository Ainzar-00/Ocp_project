...
public abstract class Hilt_ThemesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ThemesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ThemesFragment_GeneratedInjector) this.generatedComponent()).injectThemesFragment(UnsafeCasts.<ThemesFragment>unsafeCast(this));
    }
  }
