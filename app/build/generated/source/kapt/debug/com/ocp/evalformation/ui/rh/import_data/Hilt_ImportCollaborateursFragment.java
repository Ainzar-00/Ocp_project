...
public abstract class Hilt_ImportCollaborateursFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImportCollaborateursFragment() {
    super();
  }

  Hilt_ImportCollaborateursFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImportCollaborateursFragment_GeneratedInjector) this.generatedComponent()).injectImportCollaborateursFragment(UnsafeCasts.<ImportCollaborateursFragment>unsafeCast(this));
    }
  }
