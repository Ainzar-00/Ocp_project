...
public abstract class Hilt_InvitationsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InvitationsFragment() {
    super();
  }

  Hilt_InvitationsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InvitationsFragment_GeneratedInjector) this.generatedComponent()).injectInvitationsFragment(UnsafeCasts.<InvitationsFragment>unsafeCast(this));
    }
  }
